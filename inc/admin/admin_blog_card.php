    ...
    <div class="ya_setting_content">
      <div class="ya_tooltip_wrap">
        ...
        <div class="ya_tooltip">
          ...
          <br>
          <a href="<?php echo esc_url('https://docs.back2nature.jp/yahman-add-ons/how-to-display-a-blog-card/' ); ?>" target="_blank" rel="nofollow noopener noreferrer"><?php esc_html_e('How to use(Japanese)', 'yahman-add-ons'); ?></a>
        </div>
      </div>
